...
class _$UserCredentialsImpl implements _UserCredentials {
  ...
  @override
  String toString() {
    return 'UserCredentials(userId: $userId, photo: $photo, name: $name, email: $email, password: $password, gender: $gender, dateOfBirth: $dateOfBirth, bloodGroup: $bloodGroup, weight: $weight, heightFt: $heightFt, heightIn: $heightIn, address: $address)';
  }
...
abstract class _UserCredentials implements UserCredentials {
  const factory _UserCredentials(
      ...
      final String? heightFt,
      final String? heightIn,
      final String? address}) = _$UserCredentialsImpl;
