                    ...
                    Future.delayed(const Duration(seconds: 2), () {
                      if (context.mounted) {
                        context.pushReplacementNamed(
                            routeName: RoutesName.registerUserCredentials);
                ...
                builder: (context, state) {
                  return Form(
                    ...
                    child: Column(
                      ...
                      children: [
                        SizedBox(height: ScreenUtil().screenHeight * .085.h),
                        Text(
                                ...
                                : CustomButton(
                                    ...
                                    onPressed: () {
                                      FocusManager.instance.primaryFocus
                                          ?.unfocus();
                                      context.read<RegisterOtpSendBloc>().add(
                                          GetOTP(
                                              otp: int.parse(
                                                  _otpController.text)));
                                      context
                                          .read<RegisterOtpSendBloc>()
                                          .add(RegisterOtpSendApiCall());
                                    },
                                  ),
                        5.verticalSpace,
                        (state.errorMessage == "OTP max count reached" ||
                            ...
                            ? state.status ==
                                    RegisterOtpSendStatus.resendOtpLoading
                                ? SpinKitChasingDots(
                                    color: AppColors.primary, size: 50.sp)
                                : TextButton(
                                    onPressed: () {
                                      context
                                          .read<RegisterOtpSendBloc>()
